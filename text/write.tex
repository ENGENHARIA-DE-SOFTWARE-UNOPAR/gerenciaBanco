...
\begin{figure}[H]
  \centering
  \subfigure[Menu total.\label{fig:menu_total}]{\includegraphics[scale=.8]{figure/menuu.jpg}}//
  \subfigure[Saque.\label{fig:saque}]{\includegraphics[scale=.8]{figure/saqque.jpg}}//
  \subfigure[Consulta e Depósito.\label{fig:conu_depo}]{\includegraphics[scale=.8]{figure/este_4.jpg}}//
