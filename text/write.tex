...
\par Foi confeccionado uma interface gráfica para o usuario, conforme demonstra as figuras \ref{fig:face}

\begin{figure}[h!]
  \centering
  \subfigure[Menu.\label{fig:menu}]{\includegraphics[scale=.8]{figure/menu.jpg}}
